<x-layout>
    ...
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24 border-gray-500">
        ...
        <form method="POST" action="{{ route('admin.creators.store')}}" enctype="multipart/form-data">
            @csrf
            <div class="mb-6">
            ...
            <div class="mb-6">
                ...
                <input  type="text"  class="border border-gray-200 rounded p-2 w-full"  name="portfolio" value="{{old('portfolio')}}"/>
            ...
            <div class="mb-6">
                <button class="bg-black text-white rounded py-2 px-4 hover:opacity-80">Add Creator</button>
