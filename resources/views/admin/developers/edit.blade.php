    ...
    <x-card class="p-10 rounded max-w-lg mx-auto mt-24 border-gray-500">
        ...
        <form method="POST" action="{{ route('admin.developers.update', $developer)}}" enctype="multipart/form-data">
            ...
            <div class="mb-6">
                ...
                placeholder="About you, Experience etc">{{$developer->bio}}</textarea>
            ...
            <div class="mb-6">
                ...
                <input type="text" class="border border-gray-200 rounded p-2 w-full" name="email" value="{{$developer->email}}"/>
            ...
            <div class="mb-6">
                <img class="w-48" src="{{$developer->image ? asset
