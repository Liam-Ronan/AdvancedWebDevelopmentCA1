...
{{--     <a href="/" class="inline-block text-black ml-4 mb-4"><i class="fa-solid fa-arrow-left"></i> Back</a> --}}
    <a href="/projects" class="bg-black opacity-90 text-white rounded py-2 px-4 hover:bg-gray-700 ml-4 mb-8"><i class="fa-solid fa-arrow-left"></i> Back </a>
    <div class="mx-4 mt-4">
        ...
        <x-card class="p-10">
            <div class="flex flex-col items-center justify-center text-center">
                {{-- <img class="h-48 mr-6 mb-6" src="{{$project->image ? asset
                    ...
                    <img class="h-48 mr-6 mb-6" src="{{$project->image ? asset('img/'. $project->image) : asset('storage/images/no-image.png')}}" alt=""/>
                ...
                <div>
                    ...
                    <p>{{$project->description}}</p>
                        ...
                        <a href="/projects/{{$project->uuid}}/edit" class="block bg-black text-white mt-6 py-4 rounded-xl hover:opacity-80">
